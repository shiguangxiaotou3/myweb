...
class Imap extends Component{
    ...
    public bool $cache = true;  //是否开启文件缓存
    public string $path = "@app/runtime/mail";
    public string $filename = 'data.php';
    public array $defaultViewMailbox = ['Inbox'];
    public string $class ='common\modules\email\models\Mailbox';
    private string $_server;               //服务器名称
    private object $_connection;           //链接对象实例
    private object $_mailbox;              //邮箱对象
    private object $_message;              //邮件对象

    private int $_timeDifference;      //服务器与客户端时间差
    private bool $_downloadFile;        //是否下载文件
    private array $_viewMailbox;
     ...
     * @throws Exception
     */
    public function open(string $serverName)
    {
