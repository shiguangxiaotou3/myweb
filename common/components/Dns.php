...
{
    const ACCESS_KEY_ID  ='LTAIFQDQqwnWYQL2';
    const ACCESS_KEY_SECRET  ='ivWz9rxvrGNJzkSRrlbLJteHltOtve';
    private Alidns $_client;
     ...
     * @return Alidns
     */
    public  function getClient(): Alidns
    {
       return  $this->_client;
    }
    /**
     ...
     */
    public function DeleteDomain($domainName): DeleteDomainResponseBody
    {
        $client = $this->client;
     ...
     * @return array
     */
    public function domainRecords($domainName): array
    {
        $client = $this->client;
     ...
     */
    public function domainDescribeRecordLogs(string $domainName): DescribeRecordLogsResponseBody
    {
        $client = $this->client;
     ...
     */
    public function domainStatistics($domainName,$startDate): DescribeDomainStatisticsResponseBody
    {
        $client = $this->client;
     ...
     */
    public function addDomainRecord(string $domainName, string $RR, string $value, $typ="A"): AddDomainRecordResponseBody
    {
        $client = $this->client;
     ...
     */
    public function delDomainRecord(string $domainName, string $RR): DeleteSubDomainRecordsResponseBody
    {
        $client = $this->client;
     ...
     */
    public function UpdateDomainRecord($RecordId,$RR,$Type,$Value): UpdateDomainRecordResponseBody
    {
        $client = $this->client;
